# `polymake_oscarnumber_jll.jl` (v0.2.9+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/045aa9150d49d36b8201777bc761ced9b4e03eee/P/polymake_oscarnumber/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/045aa9150d49d36b8201777bc761ced9b4e03eee/P/polymake_oscarnumber/bundled)

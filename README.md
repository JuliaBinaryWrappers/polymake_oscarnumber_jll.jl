# `polymake_oscarnumber_jll.jl` (v0.3.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c24fc62a04951c3634a0d4270e36c9e7806f0f5b/P/polymake_oscarnumber/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/benlorenz/oscarnumber (revision: `b921000889c2a30ef3c90677a15a23bd16abf21d`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/c24fc62a04951c3634a0d4270e36c9e7806f0f5b/P/polymake_oscarnumber/bundled)

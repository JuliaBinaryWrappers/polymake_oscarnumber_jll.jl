# `polymake_oscarnumber_jll.jl` (v0.3.11+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/b4b81ad255517c77791ade9f4e1e0a1b4e0d1fcf/P/polymake_oscarnumber/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/b4b81ad255517c77791ade9f4e1e0a1b4e0d1fcf/P/polymake_oscarnumber/bundled)

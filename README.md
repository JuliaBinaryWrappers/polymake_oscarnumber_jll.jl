# `polymake_oscarnumber_jll.jl` (v0.2.3+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5e7fb45eb130557ddb9acb2b2cd5e870a8d7527e/P/polymake_oscarnumber/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/benlorenz/oscarnumber (revision: `110fec846eaad90e99abf0ac5f0882d6bcd6ac6b`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/5e7fb45eb130557ddb9acb2b2cd5e870a8d7527e/P/polymake_oscarnumber/bundled)

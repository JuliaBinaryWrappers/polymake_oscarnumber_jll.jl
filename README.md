# `polymake_oscarnumber_jll.jl` (v0.3.8+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/91caa2dead2586b9891b25f64033453193974009/P/polymake_oscarnumber/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/91caa2dead2586b9891b25f64033453193974009/P/polymake_oscarnumber/bundled)

# `polymake_oscarnumber_jll.jl` (v0.1.3+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c5e4f4b814208b7ed57f6ec35b68fdf52c2f1a35/P/polymake_oscarnumber/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/benlorenz/oscarnumber (revision: `d8e8fbecf8a05129aee1ea3fea539c935938ece9`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/c5e4f4b814208b7ed57f6ec35b68fdf52c2f1a35/P/polymake_oscarnumber/bundled)
